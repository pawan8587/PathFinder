package com.enest.pc_68.pathfinder.coordinatorCustomLibs;
...
import com.enest.pc_68.pathfinder.*;

import java.lang.ref.WeakReference;

import com.enest.pc_68.pathfinder.coordinatorCustomLibs.*;
    ...
    private void setStatusBarBackgroundVisible(boolean visible){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            if(visible){
                ...
                window.setStatusBarColor(ContextCompat.getColor(mContext, R.color.primary));
            }else {
                Window window = ((Activity)mContext).getWindow();
