...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    LatLng car2 = new LatLng(30.711303, 76.697527);
    LatLng car3 = new LatLng(30.708167, 76.698771);
    LatLng car4 = new LatLng(30.707078, 76.696695);
    LatLng car5 = new LatLng(30.710768, 76.692141);
    LatLng car6 = new LatLng(30.708315, 76.691454);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //autoCompleteFragmentSource.setFilter(typeFilter);
        //autoCompleteFragmentDestination.setFilter(typeFilter);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_car_green)).position(car2));

        googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_car_orange)).position(car3));

        googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_car_red)).position(car4));

        googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_car_green)).position(car5));

        googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_car_blue)).position(car6));
